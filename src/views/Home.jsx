        ...
        <>
            <div id='home' className={"flex flex-col h-full pt-24 mb-24 justify-center max-w-[1000px] w-full"}>
                ...
                <p className={"py-8 slate text-md leading-7 opacity-60 max-w-[600px]"}>
                    As a Front-End Developer, I specialize in crafting visually stunning and intuitive user experiences that help businesses achieve their goals. With expertise in HTML, CSS, JavaScript, and React, I'm passionate about bringing ideas to life and creating seamless digital experiences that leave a lasting impression.
                </p>
